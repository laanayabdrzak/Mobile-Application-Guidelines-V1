...
Category | Key issues
------------ | -------------
Authentication and Authorization | **• Failing to authenticate and authorize in occasionally connected scenarios.**<br>**• Failing to use authentication and authorization over a virtual private network (VPN).**<br>**• Failing to authenticate for all connection scenarios, such as WIFI, 4G, etc..**<br>**• Failing to add 2FA.**
